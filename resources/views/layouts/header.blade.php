...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light" style="background-color: #e3f2fd;">
    <a class="navbar-brand" href="/">
        <img src="/cricket_images/logo.jpeg" width="40" height="40" alt="">
      </a>
      <a class="navbar-brand" href="/">Cricket Accademy</a>
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownId">
                      ...
                      <a class="dropdown-item" href="/future">Future Approach</a>
                  </div>
              </li>
              <li class="nav-item">
